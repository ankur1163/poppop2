...
import {
  ...
  Label, Progress, Icon,Nav,NavItem,
  SidebarDivider
            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <Nav bsStyle="pills" className='nav-green' stacked activeKey={2}>
          ...
          <Grid>
            <Row className='fg-white'>
              ...
              <Col xs={8} collapseLeft id='avatar-col'>
                <div style={{top: 23, fontSize: 16, lineHeight: 1, position: 'relative'}}>Megha Sanchez</div>
                <div>
                  <Progress id='demo-progress' value={80} color='#ffffff'/>
                  <a href='#'>
